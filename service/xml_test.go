...
func TestNewXMLItem_TVEnrichment(t *testing.T) {
	...
	want := `<item><title>Breaking Bad S01E01 720p BluRay</title><guid isPermaLink="false">def456</guid><link>magnet:?xt=urn:btih:def456</link><enclosure url="magnet:?xt=urn:btih:def456" length="4294967296" type="application/x-bittorrent;x-scheme-handler/magnet"></enclosure><size>4294967296</size><pubDate>Thu, 09 Apr 2026 10:00:00 +0000</pubDate><torznab:attr name="seeders" value="25"></torznab:attr><torznab:attr name="leechers" value="2"></torznab:attr><torznab:attr name="infohash" value="def456"></torznab:attr><torznab:attr name="category" value="5000"></torznab:attr><torznab:attr name="category" value="5040"></torznab:attr><torznab:attr name="resolution" value="720p"></torznab:attr><torznab:attr name="encoding" value="x264"></torznab:attr><torznab:attr name="source" value="BluRay"></torznab:attr><torznab:attr name="releasegroup" value="GROUP"></torznab:attr><torznab:attr name="series" value="Breaking Bad"></torznab:attr><torznab:attr name="season" value="1"></torznab:attr><torznab:attr name="episode" value="1"></torznab:attr></item>`
...
func TestXMLRSS_Namespace(t *testing.T) {
	...
	want := `<rss version="2.0" xmlns:torznab="http://torznab.com/schemas/2015/feed"><channel><title>mgnx</title><description>mgnx Torznab indexer</description><item><title>Test</title><guid isPermaLink="false">abc123</guid><link>magnet:?xt=urn:btih:abc123</link><enclosure url="magnet:?xt=urn:btih:abc123" length="1024" type="application/x-bittorrent;x-scheme-handler/magnet"></enclosure><size>1024</size><pubDate></pubDate><torznab:attr name="seeders" value="1"></torznab:attr><torznab:attr name="leechers" value="0"></torznab:attr><torznab:attr name="infohash" value="abc123"></torznab:attr></item></channel></rss>`
