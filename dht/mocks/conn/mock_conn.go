...
// Source: github.com/kdwils/mgnx/dht (interfaces: Conn)
//
// Generated by this command:
//
//	mockgen -destination=mocks/conn/mock_conn.go -package=mocks github.com/kdwils/mgnx/dht Conn
//
...
func (mr *MockConnMockRecorder) ReadFromUDP(b any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadFromUDP", reflect.TypeOf((*MockConn)(nil).ReadFromUDP), b)
}
...
func (mr *MockConnMockRecorder) WriteToUDP(b, addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteToUDP", reflect.TypeOf((*MockConn)(nil).WriteToUDP), b, addr)
}
